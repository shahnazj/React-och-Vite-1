      ...
      <div className="container space-y-3">
          ...
          <div className="market-btns">
            <a href="#" className="store-btn">
              ...
              <img
                ...
                src="/images/icons/appstore-light.svg"
                alt=""
              />
              <img
                className="show-dark"
                src="/images/icons/appstore-dark.svg"
                alt=""
              />
            </a>
            <a href="#" className="store-btn">
              ...
              <img
                className="show-light"
                src="/images/icons/google-light.svg"
                alt=""
              />
              <img
                className="show-dark"
                src="/images/icons/google-dark.svg"
                alt=""
              />
            </a>
          </div>
        ...
        <div className="phone-img-container">
          <img
            ...
            alt="two iphones with charts and credit card on the screen"
          />
        </div>
      </div>
    </section>
